    ...
    <div id={"editor-#{@id}"} class="decoration-element-editor">
      <div class="element-editor-header">
        ...
        <div class="element-actions">
          <button type="button" phx-click={@on_delete} phx-value-id={@id} class="delete-element-btn">
            删除
          </button>
        </div>
      </div>
    ...
    <div class="title-editor">
      <div class="form-group">
        ...
        <input
          ...
          name="title"
          value={@element.title}
          phx-change="update_decoration_element"
