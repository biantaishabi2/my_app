defmodule MyAppWeb.TestUploadLive do
  ...
  def mount(params, _session, socket) do
    ...
    Logger.info(
      "Mounting TestUploadLive with form_id: #{inspect(form_id)}, field_id: #{inspect(field_id)}"
    )
  ...
  def handle_event("save", params, socket) do
    ...
    uploaded_files =
      consume_uploaded_entries(socket, :avatar, fn %{path: path}, entry ->
        ...
        result =
          if Map.has_key?(result, :content_type) do
            result
    ...
    <div class="container mx-auto p-6">
      <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="p-6" phx-drop-target={@uploads.avatar.ref}>
          <.form for={%{}} id="upload-form" phx-submit="save" phx-change="validate">
            <div class="space-y-6">
              <div>
                <div class="flex flex-col md:flex-row md:items-end gap-4 mb-6">
                  <div class="flex-1">
                    <.label for={@uploads.avatar.ref}>选择文件</.label>
                    <div class="mt-2">
                      <.live_file_input
              ...
              <div :if={@uploads.avatar.entries != []}>
                ...
                <div
                  ...
                  class="mt-2 bg-gray-50 rounded-lg p-3 shadow-sm"
                >
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="text-xs text-gray-600 flex gap-3 items-center">
                        ...
                        <span
                          :if={entry.progress < 100}
                          class="text-xs text-indigo-600 whitespace-nowrap"
                        >
                          {entry.progress}%
                        </span>
                        <span
              ...
              <div :if={@uploaded_files != []}>
                      ...
                      <div class="flex gap-3">
                          ...
                          <% else %>
                            <div class="w-full h-full flex items-center justify-center bg-gray-200">
                              <div class="text-xs text-center font-semibold">
                                {Path.extname(file_info.original_filename)}
                              </div>
                            </div>
                          <% end %>
                        </div>
                        <div class="flex-1 min-w-0">
                          ...
                          <a
                            href={file_info.path}
                            target="_blank"
                            class="text-xs text-indigo-600 hover:text-indigo-800 hover:underline inline-flex items-center mt-1"
                          >
                            查看文件
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="mt-6 text-center bg-indigo-50 border border-indigo-100 rounded-lg p-3">
                  <p class="text-indigo-800 text-sm">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5 inline-block mr-1 text-indigo-600"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
